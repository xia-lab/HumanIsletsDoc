...
*Current coverage: 126 donors.* *(Added 2025-02.)*

Prohormone expression measurements (insulin, glucagon and processing intermediates) are provided for islets from a subset of donors. Data appear in the Donor View as a dedicated tab. *Detailed protocol to be added in a follow-up update.*

## Ancestry

*Current coverage: 404 donors.* *(Added 2024-12.)*
...
Lipid extraction is performed on whole pancreas samples (not isolated islets) for a subset of donors. Data appear in the Donor View as a dedicated tab. *Detailed protocol to be added in a follow-up update.*

...
description: |
  This is the documentation for HumanIslets 2.0.
---
...
McGill University is situated on the traditional territory of the Kanien’kehà:ka, a place of meeting and exchange amongst many First Nations including the Kanien’kehá:ka of the Haudenosaunee Confederacy, Huron/Wendat, Abenaki, and Anishinaabeg.
...
Carleton University and the University of Ottawa are located on the traditional, unceded territory of the Algonquin Anishinaabe people.

Stanford University sits on the ancestral and unceded lands of the Muwekma Ohlone people.

## Terms of Use

Users are required to cite the use of this resource in any publication arising from its use or access. This can be done by citing **[Ewald et al., *Cell Metab*, 2025](https://www.cell.com/cell-metabolism/abstract/S1550-4131(24)00365-6)** (and Yao et al., *in preparation*) and via the following acknowledgement:


> *"This work includes data and/or analyses from HumanIslets.com funded by the Canadian Institutes of Health Research, JDRF Canada, and Diabetes Canada (5-SRA-2021-1149-S-B/TG 179092) with data from islets isolated by the Alberta Diabetes Institute IsletCore with the support of the Alberta Health Services Give Life Alberta program, BC Transplant, Ontario Health Trillium Gift of Life Network (TGLN), Transplant Quebec, and other Canadian organ procurement organizations with written informed donor consent as approved by the Human Research Ethics Board at the University of Alberta (Pro00013094)."*
...
Because datasets are occasionally updated, which may impact normalization and analyses, **_users should report the web tool version, and date of web tool access, analysis, and/or data download._**  To facilitate this, data downloads are provided with a time/date stamp.

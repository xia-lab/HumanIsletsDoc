...
*Current coverage: 215 metabolite features across 43 donors, measured at low (2.8 mM) and high (16.7 mM) glucose, with ratio also reported.* *(Added 2024-10; expanded 2026-02.)*

Metabolomics profiling is performed on islet samples collected at the ADI IsletCore. Compounds are reported at the metabolite-ratio level and grouped by main class, sub class, and HMDB ID. *Detailed protocol and methods to be added in a follow-up update.*

## Environmental Contaminants

*Current coverage: 234 contaminant features across 34 donors. Some entries gated to authorized users pending publication.* *(Added 2025-04.)*

Environmental chemical contaminants are quantified in islet and tissue samples. Because contaminant data are typically zero-inflated and non-normal, in-tool analyses use Kendall rank correlation (partial Kendall when covariates are supplied) rather than the moderated-t approach used for transcriptomics/proteomics. *Detailed protocol and provider information to be added in a follow-up update.*

## Metabolic Flux

*Current coverage: 2,771 reactions at high glucose (2,775 at low glucose; 2,765 in ratio form) across 375 donors.* *(Added 2025-10.)*

Donor-specific genome-scale metabolic models (GEMs) are built using the tINIT algorithm, integrating each donor's bulk RNA-seq profile into the Human1 generic metabolic reconstruction. Flux is inferred via Flux Variability Analysis (FVA) at 90% optimality combined with OptGP flux sampling, with ATP hydrolysis as the objective function. Each donor is simulated at low (2.8 mM, fasting) and high (16.7 mM, post-meal) glucose; the ratio captures glucose responsiveness at the metabolic level. *Full methods to be added in a follow-up update.*
